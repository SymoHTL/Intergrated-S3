...
/// <summary>
/// Input parameters for generating a SigV4 presigned URL via <see cref="S3SigV4Presigner.Presign"/>.
/// </summary>
public sealed class S3SigV4PresignParameters
{
    ...
    /// <summary>
    /// The AWS secret access key used for signing key derivation.
    /// </summary>
    public required string SecretAccessKey { get; init; }

    /// <summary>
    /// The AWS region for the credential scope (e.g. <c>us-east-1</c>).
    /// </summary>
