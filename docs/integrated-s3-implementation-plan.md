...
- Remaining scope:
  - next: continue versioning/tagging/delete-marker parity work for the remaining advanced edge cases now that the current conditional, UploadPartCopy, checksum-header validation, raw-query SigV4, standard object-header, multipart listing, and canonical XML namespace gaps are covered
